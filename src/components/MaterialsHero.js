    ...
    return ( 
        <div className="materials-hero">
            ...
            <div id="conversation-info" className="materials-hero-info" onMouseEnter={conversationContrastChange} onMouseLeave={() => setConversationContrast("materials-hero-img")}>
                ...
                <a href="https://thunderbolton.github.io/Conversation-app/" target="_blank"><button id="conversation-btn" className="materials-hero-info-btn">Jump into daily conversation</button></a>
            </div>
            ...
            <div id="news-info" className="materials-hero-info" onMouseEnter={newsContrastChange} onMouseLeave={() => setNewsContrast("materials-hero-img")}>
                ...
                <a href="https://readthelatest.herokuapp.com/" target="_blank"><button id="news-btn" className="materials-hero-info-btn">Read the latest news</button></a>
            </div>
            ...
            <div className="materials-hero-info-btn-sm">
                <a href="https://thunderbolton.github.io/Conversation-app/" target="_blank"><button id="conversation-btn-sm" onMouseEnter={conversationContrastChange} onMouseLeave={() => setConversationContrast("materials-hero-img")}>Jump into daily conversation</button></a>
                <a href="https://readthelatest.herokuapp.com/" target="_blank"><button id="news-btn-sm" onMouseEnter={newsContrastChange} onMouseLeave={() => setNewsContrast("materials-hero-img")}>Read the latest news</button></a>
            </div>
        </div>
     );
}
